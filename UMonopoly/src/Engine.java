...
public class Engine 
{
    ...
    public Engine(int x, String name1, String kolor1, String name2,String kolor2, String name3, String kolor3,String name4,String kolor4) 
    {
        ...
        gracze.get(0).setName(name1);
        log=log+"Witamy "+ gracze.get(0).getName()+"\n";
        gracze.get(1).setKolor(kolor2);
        gracze.get(1).setName(name2);
        log=log+"Witamy "+ gracze.get(1).getName()+"\n";
        gracze.get(2).setKolor(kolor3);
        gracze.get(2).setName(name3);
        log=log+"Witamy "+ gracze.get(2).getName()+"\n";
        gracze.get(3).setKolor(kolor4);
        gracze.get(3).setName(name4);
        log=log+"Witamy "+ gracze.get(3).getName()+"\n";
     ...
     public Engine(int x, String name1, String kolor1, String name2,String kolor2, String name3, String kolor3) 
    {
        gracze = new ArrayList(x);
        log="";
        for(int i=0;i<x;i++)
      ...
      public Engine(int x, String name1, String kolor1, String name2,String kolor2) 
    {
        gracze = new ArrayList(x);
        log="";
        for(int i=0;i<x;i++)
    ...
    public int getIdAktywny()
    {
        return aktywny_gracz;
    }
